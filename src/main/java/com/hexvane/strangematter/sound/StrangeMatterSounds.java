...
public class StrangeMatterSounds {
    ...
    // Hoverboard sounds
    public static final DeferredHolder<SoundEvent, SoundEvent> HOVERBOARD_LOOP = registerSoundEvent("hoverboard_loop");
    public static final DeferredHolder<SoundEvent, SoundEvent> HOVERBOARD_JUMP = registerSoundEvent("hoverboard_jump");
