...
public class ShardCrystalColorHandler {
    ...
    public static void registerBlockColors(RegisterColorHandlersEvent.Block event) {
        ...
        registerCrystalColor(event, StrangeMatterMod.SHADE_SHARD_LAMP, SHADE_COLOR);
        registerCrystalColor(event, StrangeMatterMod.GRAVITIC_SHARD_LAMP, GRAVITIC_COLOR);
        registerCrystalColor(event, StrangeMatterMod.ENERGETIC_SHARD_LAMP, ENERGETIC_COLOR);
        registerCrystalColor(event, StrangeMatterMod.INSIGHT_SHARD_LAMP, INSIGHT_COLOR);
        registerCrystalColor(event, StrangeMatterMod.CHRONO_SHARD_LAMP, CHRONO_COLOR);
        registerCrystalColor(event, StrangeMatterMod.SPATIAL_SHARD_LAMP, SPATIAL_COLOR);
    }
